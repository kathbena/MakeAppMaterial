    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                //Animation to rotate the floating action button once selected
                ViewCompat.animate(fab).rotation(360.0F).withLayer().setDuration(300L)
        ...
        if (mCursor != null) {
            ...
            bodyView.setText(Html.fromHtml(
                    DateUtils.getRelativeTimeSpanString(
                            ...
                            + "<br/><br/>" + mCursor.getString(ArticleLoader.Query.BODY)));
